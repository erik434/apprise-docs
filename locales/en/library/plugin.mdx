...
:::tip
When parsing query-string flags and values, prefer the shared helpers in `apprise.utils`. See the [Utilities Reference](./utilities/).
:::
...
## Persistent storage opt-in (`storage_mode`)
